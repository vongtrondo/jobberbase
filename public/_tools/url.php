	...
	*/
	...
	public static function sanitize_title_with_dashes($title) {
		$title = trim($title);
		   ...
		   $title = preg_replace('/<(\/{0,1})img(.*?)(\/{0,1})\>/', 'image', $title);
		   $find = array(' ',
			  '&quot;',
			  'quot',
			  '&',
		   ...
		   $find = array('à',
			  ...
			  'ẳ',
			  'ẵ');
		   $title = str_replace ($find, 'a', $title);
		$find = array('è',
			  'é',
			  'ẹ',
			  'ẻ',
			  ...
			  'ể',
			  'ễ');
		   $title = str_replace ($find, 'e', $title);
		 $find = array('ì',
			  'í',
			  'ị',
			  'ỉ',
			  'ĩ');
		   $title = str_replace ($find, 'i', $title);
		$find = array('ò',
			  'ó',
			  'ọ',
			  'ỏ',
			  ...
			  'ở',
			  'ỡ');
		   $title = str_replace ($find, 'o', $title);
		 $find = array('ù',
			  'ú',
			  'ụ',
			  'ủ',
			  ...
			  'ử',
			  'ữ');
		   $title = str_replace ($find, 'u', $title);
		 $find = array('ỳ',
			  'ý',
			  'ỵ',
			  'ỷ',
			  'ỹ');
		   $title = str_replace ($find, 'y', $title);
		 $find = array('đ',
			   'Đ');
		   $title = str_replace ($find, 'd', $title);
		   $find = array('ü',
			   'Ü');
		   $title = str_replace ($find, 'ue', $title);
		   $find = array('ß');
		   $title = str_replace ($find, 'ss', $title);
		   $find = array('ç');
		   $title = str_replace ($find, 'c', $title);
		   $find = array('/[^a-z0-9\-<>]/',
			  '/[\-]+/',
			  '/<[^>]*>/');
		   $repl = array('',
			  '-',
			  '');
		   $title = preg_replace ($find, $repl, $title);
